...
import { FaArrowUp } from 'react-icons/fa'; // Import the missing icon
    ...
    >
      <div className="md:w-1/2 flex flex-col text-lg">
        ...
        <div className="w-full flex justify-center md:justify-start">
          ...
          >
            <ul className=" my-8 flex flex-col gap-4">
              {['LogIn', 'Enter Video Url', 'Configure Settings', 'Run Analysis', 'View Insights'].map(
                (step, index) => (
                  <li key={index} className="step text-2xl flex flex-col font-bold">
        ...
        <div className="flex w-full justify-center md:justify-start">
          ...
          >
            <FaArrowUp className="md:h-6 md:w-6 mr-2 bg-transparent" />
            Top
          </Plx>
        </div>
      </div>
